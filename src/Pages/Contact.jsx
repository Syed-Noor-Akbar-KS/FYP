...
function Contact() {
  ...
  <div className="main-wrapper">
    ...
    <form className="form-wrapper">
      ...
      <div className="form-card">
        <textarea className="form-textarea" maxLength={420} rows={3} name="phone_number" required="required" defaultValue={""} />
        <label className="form-textarea-label" htmlFor="phone_number">Address</label>
      </div>
